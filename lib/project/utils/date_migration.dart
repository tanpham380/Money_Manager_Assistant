    ...
    try {
      ...
      for (final transaction in allTransactions) {
        ...
        try {
          ...
          print('Failed to migrate date for transaction ${transaction.id}: ${transaction.date} - Error: $e');
          failed++;
        }
      }
      
      print('Date migration complete: $migrated migrated, $failed failed out of ${allTransactions.length} total');
